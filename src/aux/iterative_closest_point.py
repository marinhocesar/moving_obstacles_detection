...
def get_displacement_for_significant_points(
    ...
    # A_apparent = aux.get_numpy_array_from_points(points=last_apparent_significant)
    # B_apparent = aux.get_numpy_array_from_points(points=compare_apparent_sig)

    # history, C_apparent = icp(A_apparent, B_apparent, verbose=True, point_pairs_threshold=5)
    # compare_apparent_sig = aux.get_points_from_numpy_array(numpy_array=C_apparent)
